...
<html>
<head>
	<title>ZeeStream: Animated Features</title>
	<meta charset="utf-8">
...
<body>
	...
	<nav class="topnav">
			...
			<div class="dropdown">
				...
				<div class="dropdown-content">
					<a href="dashboard.php" style="font-size: 15px; color: white;">MyStreamAccount</a>
				</div>
			</div>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<h1 style="text-align: center;color: white;font-family: consolas; font-size: 23px;">Animated Features(n)</h1>
