...
<html>
<head>
	<title>ZeeStream : Top TV Series</title>
	<meta charset="utf-8">
...
<body>
	...
	<h1 style="text-align: center;color: white;font-family: consolas; font-size: 23px;">Top TV Series(n)</h1>

	<hr>
	<div>
		<p> <a href="5.a.loggedin_user.php"><< Back</a> </p>
		<div>
			...
			<div style="display: inline-block; position: relative;">
				<a href="" title="The Queens Gambit: Season 1" class="ParentImage"><img src="1.Images/Witcher/queens gambit.jpg"></a>
				<div class="bottomLeft">
					<br><a href="">The Queens Gambit: Season 1</a>
					<br> <span class="starView1">********</span><span class="starView2">**</span>
				</div>
			</div>&nbsp;&nbsp;
