...
<html>
<head>
	<title>Rider's of Justice Trailer</title>
	<meta charset="utf-8">
...
<body>
	...
	<div class="videoPos">
		...
		Rider's of Justice - Trailer (2021) <span class="videoRating"> 7.0 </span> </h3>

		<div class="videoCenter">
			<video class="videoCenter" width="900px" height="440px" poster="1.Images/12.riders2.png" controls >

				<source src="2.Videos/9.riders.mp4" type="video/mp4"> 
				<source src="2.Videos/9.riders.ogg" type="video/ogg">
				<source src="2.Videos/9.riders.webm" type="video/webm">
