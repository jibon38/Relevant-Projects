...
<html>
<head>
	<title>ZeeStream : Batman Begins</title>
	<meta charset="utf-8">
...
<body>
	...
	<div class="videoPos">
		...
		Batman Begins  <span class="videoRating"> 9.0 </span> </h3>

		<div class="videoCenter">
			<video class="videoCenter" width="900px" height="440px" poster="1.Images/batman2.jpg" controls >

				<source src="2.Videos/Hollywood/Batman begins.mp4" type="video/mp4"> 
				<source src="2.Videos/Hollywood/Batman begins.ogg" type="video/ogg">
				<source src="2.Videos/Hollywood/Batman begins.webm" type="video/webm">
