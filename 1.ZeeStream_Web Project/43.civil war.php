...
<html>
<head>
	<title>ZeeStream : Captain America - Civil War</title>
	<meta charset="utf-8">
...
<body>
	...
	<div class="videoPos">
		...
		Captain America: Civil War  <span class="videoRating"> 9.0 </span> </h3>

		<div class="videoCenter"> 
			<video class="videoCenter" width="900px" height="440px" poster="1.Images/civil war.jpg" controls >

				<source src="2.Videos/Hollywood/Civil War.mp4" type="video/mp4"> 
				<source src="2.Videos/Hollywood/Civil War.ogg" type="video/ogg">
				<source src="2.Videos/Hollywood/Civil War.webm" type="video/webm">
