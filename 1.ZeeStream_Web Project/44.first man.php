...
<html>
<head>
	<title>ZeeStream : First Man</title>
	<meta charset="utf-8">
...
<body>
	...
	<div class="videoPos">
		...
		First Man  <span class="videoRating"> 8.0 </span> </h3>

		<div class="videoCenter">
			<video class="videoCenter" width="900px" height="440px" poster="1.Images/first man.jpg" controls >

				<source src="2.Videos/Hollywood/First Man.mp4" type="video/mp4"> 
				<source src="2.Videos/Hollywood/First Man.ogg" type="video/ogg">
				<source src="2.Videos/Hollywood/First Man.webm" type="video/webm">
