...
<html>
<head>
	<title>ZeeStream : Green Lantern - The First Flight</title>
	<meta charset="utf-8">
...
<body>
	...
	<div class="videoPos">
		...
		Green Lantern: The First Flight   <span class="videoRating"> 8.0 </span> </h3>

		<div class="videoCenter">
			<video class="videoCenter" width="900px" height="440px" poster="1.Images/gl first flight.jpg" controls >

				<source src="2.Videos/Hollywood/Animation/Green lantern first flight.mp4" type="video/mp4"> 
				<source src="2.Videos/Hollywood/Animation/Green lantern first flight.ogg" type="video/ogg">
				<source src="2.Videos/Hollywood/Animation/Green lantern first flight.webm" type="video/webm">
