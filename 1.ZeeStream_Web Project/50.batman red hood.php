...
<html>
<head>
	<title>ZeeStream : Batman - Under The Red Hood</title>
	<meta charset="utf-8">
...
<body>
	...
	<div class="videoPos">
		...
		Batman: Under The Red Hood   <span class="videoRating"> 9.0 </span> </h3>

		<div class="videoCenter">
			<video class="videoCenter" width="900px" height="440px" poster="1.Images/red hood.jpg" controls >

				<source src="2.Videos/Hollywood/Animation/Batman under red hood.mp4" type="video/mp4"> 
				<source src="2.Videos/Hollywood/Animation/Batman under red hood.ogg" type="video/ogg">
				<source src="2.Videos/Hollywood/Animation/Batman under red hood.webm" type="video/webm">
