...
<body>
	...
	<h1 style="text-align: center;color: white;font-family: consolas; font-size: 23px;">Sorry! This Feature Isn't Implemented Yet.</h1>
	<hr>
						...
						<?php
							...
							if($result = mysqli_query($link, $sql))
							{
								while($row = mysqli_fetch_array($result))
								{
									...
									echo ' <a href="dashboardEdit.php" style="float: right; color: #27586e; font-weight: bold;" class="editInput">
											Edit
											</a> ';
								}
							}
							...
							{
								echo ' <input type="date" name="BirthDate" value="<?php echo htmlspecialchars($BirthDate);?>" readonly > ';
				...
				<tr>
					...
					<td class="dashboardContent2">
						...
						<?php
							...
							{
								echo ' <input type="text" name="State" placeholder="your state" readonly > ';
