...
<html>
<head>
	<title>The Space Between Trailer</title>
	<meta charset="utf-8">
...
<body>
	...
	<div>
		...
		The Space Between - Trailer (2021) </p>

		<div class="videoCenter">
			<video class="videoCenter" width="900px" height="420px" poster="1.Images/16.space.png" controls >

				<source src="2.Videos/12.space.mp4" type="video/mp4"> 
				<source src="2.Videos/12.space.ogg" type="video/ogg">
				<source src="2.Videos/12.space.webm" type="video/webm">
