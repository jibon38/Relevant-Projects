...
<html>
<head>
	<title>Mainstream Trailer</title>
	<meta charset="utf-8">
...
<body>
	...
	<div class="videoPos">
		...
		Mainstream  - Trailer (2021) <span class="videoRating"> 6.0 </span> </h3>

		<div class="videoCenter">
			<video class="videoCenter" width="900px" height="440px" poster="1.Images/17.mainstream2.png" controls >

				<source src="2.Videos/13.mainstream.mp4" type="video/mp4"> 
				<source src="2.Videos/13.mainstream.ogg" type="video/ogg">
				<source src="2.Videos/13.mainstream.webm" type="video/webm">
