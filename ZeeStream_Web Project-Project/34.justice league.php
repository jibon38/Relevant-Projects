...
<html>
<head>
	<title>Zack Snyder's Justice League Trailer</title>
	<meta charset="utf-8">
...
<body>
	...
	<div class="videoPos">
		...
		Zack Snyder's Justice League  - Trailer (2021) <span class="videoRating"> 9.0 </span> </h3>

		<div class="videoCenter">
			<video class="videoCenter" width="900px" height="440px" poster="1.Images/21.justice league2.png" controls >

				<source src="2.Videos/15.justice league.mp4" type="video/mp4"> 
				<source src="2.Videos/15.justice league.ogg" type="video/ogg">
				<source src="2.Videos/15.justice league.webm" type="video/webm">
