...
<body>
	...
	<div class="videoPos">
		...
		Frontier: Season 2 - Episode 2  <span class="videoRating"> 7.0 </span> </h3>

		<div class="videoCenter">
			<video class="videoCenter" width="900px" height="440px" poster="1.Images/Witcher/frontier.jpg" controls >

				<source src="2.Videos/Frontier_Season2/Episode-2-1.mp4" type="video/mp4"> 
				<source src="2.Videos/Frontier_Season2/Episode-2-1.ogg" type="video/ogg">
				<source src="2.Videos/Frontier_Season2/Episode-2-1.webm" type="video/webm">
	...
	<div >
		...
		<div>
			...
			<a href="36.frontier season 2 episode 4.php" title="Frontier: Season 1 - Episode 4"><img src="1.Images/Witcher/frontier.jpg"></a>&nbsp;&nbsp;
