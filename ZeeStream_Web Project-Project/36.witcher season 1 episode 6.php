...
<body>
	...
	<div class="videoPos">
		...
		The Witcher: Season 1 - Episode 6  <span class="videoRating"> 8.0 </span> </h3>

		<div class="videoCenter">
			<video class="videoCenter" width="900px" height="440px" poster="1.Images/Witcher/1.witcher.jpg" controls >

				<source src="2.Videos/Witcher_Season1/Episode-6.mp4" type="video/mp4"> 
				<source src="2.Videos/Witcher_Season1/Episode-6.ogg" type="video/ogg">
				<source src="2.Videos/Witcher_Season1/Episode-6.webm" type="video/webm">
	...
	<div >
		<p>Recommended:</p>
		<div>
			<a href="36.witcher season 1 episode 7.php" title="The Witcher: Season 1 - Episode 7"><img src="1.Images/Witcher/1.witcher.jpg"></a>&nbsp;&nbsp;
