...
<html>
<head>
	<title>ZeeStream : Hercules</title>
	<meta charset="utf-8">
...
<body>
	...
	<div class="videoPos">
		...
		Hercules  <span class="videoRating"> 7.0 </span> </h3>

		<div class="videoCenter">
			<video class="videoCenter" width="900px" height="440px" poster="1.Images/hercules.jpg" controls >

				<source src="2.Videos/Hollywood/Hercules.mp4" type="video/mp4"> 
				<source src="2.Videos/Hollywood/Hercules.ogg" type="video/ogg">
				<source src="2.Videos/Hollywood/Hercules.webm" type="video/webm">
