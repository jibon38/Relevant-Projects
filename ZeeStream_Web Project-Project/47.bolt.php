...
<body>
	...
	<div class="videoPos">
		...
		Bolt  <span class="videoRating"> 8.0 </span> </h3>

		<div class="videoCenter">
			<video class="videoCenter" width="900px" height="440px" poster="1.Images/bolt.jpg" controls >

				<source src="2.Videos/Hollywood/Animation/Bolt.mp4" type="video/mp4"> 
				<source src="2.Videos/Hollywood/Animation/Bolt.ogg" type="video/ogg">
				<source src="2.Videos/Hollywood/Animation/Bolt.webm" type="video/webm">
