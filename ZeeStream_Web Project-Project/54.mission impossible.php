...
<html>
<head>
	<title>ZeeStream : Mission Impossible</title>
	<meta charset="utf-8">
...
<body>
	...
	<div class="videoPos">
		...
		Mission Impossible    <span class="videoRating"> 8.0 </span> </h3>

		<div class="videoCenter">
			<video class="videoCenter" width="900px" height="440px" poster="1.Images/mission fallout.jpg" controls >

				<source src="2.Videos/Hollywood/Mission Impossible.mp4" type="video/mp4"> 
				<source src="2.Videos/Hollywood/Mission Impossible.ogg" type="video/ogg">
				<source src="2.Videos/Hollywood/Mission Impossible.webm" type="video/webm">
	...
	<div>
		<p><a href="5.a.loggedin_user.php"> << Back </a> <br>
		 </p>

		<div class="videoCenter">
			<video class="videoCenter" width="940px" height="470px" poster="" controls >
	...
	<div >
		<p>Recommended:</p>
		<div>
			<a href="36.witcher season 1 episode 3.php" title="The Witcher: Season 1 - Episode 3"><img src="1.Images/Witcher/1.witcher.jpg"></a>&nbsp;&nbsp;
			<a href="" title="The Queens Gambit: Season 1"><img src="1.Images/Witcher/queens gambit.jpg"></a>&nbsp;&nbsp;
			<a href="36.frontier season 2 episode 1.php" title="Frontier: Season 2 - Episode 1"><img src="1.Images/Witcher/frontier.jpg"></a>&nbsp;&nbsp;
