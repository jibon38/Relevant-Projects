		...
		if (empty($fieldErr)) 
		{
			...
			if ($stmt = mysqli_prepare($link, $sql)) 
    		{
    			...
    			if (mysqli_stmt_execute($stmt)) 
    			{
    				...
    				header("location: user_dashboard.php");   // after successful update, redirect to final dashboard.
    			}
    			else{
...
<body>
	...
	<nav class="topnav">
			...
			<div class="dropdown">
				...
				<div class="dropdown-content">
					<a href="dashboardEdit.php" style="font-size: 15px; color: white;">MyStream Account</a>
				</div>
			</div>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
